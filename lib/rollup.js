    ...
    plugins: [
      {
        async resolveId(id, importer) {
          ...
          const explicitId = importer + id;

          if (globalThis.sosseImageMin[explicitId]) {
            return await globalThis.sosseImageMin[explicitId];
          }
          ...
          globalThis.sosseImageMin[explicitId] = imageminPromise;
